...
<body>
	...
	<!-- 중앙 -->
	<div class="main">
	<input type="hidden" value="${memberCommand.memId }"/>
		<table>
		<thead>
			<tr>
				<th colspan="2">'${memberCommand.memId }'의 PW 변경 완료!
				</th>
			</tr></thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<input type="button" class="btn" value="리스트" onclick="location.href='memList'" />
				<input type="button" class="btn" value="확인" onclick="location.href='memInfo?memId=${memberCommand.memId}'" />
				</div></td>
			</tr></tfoot>
		</table>
	</div>
