...
<body>
	...
	<!-- 중앙 -->
	<div class="main">
	<input type="hidden" value="${tutorCommand.tutorId }"/>
		<table>
		<thead>
			<tr>
				<th colspan="2">'${tutorCommand.tutorId }'의 PW 변경 완료!
				</th>
			</tr></thead>
		<tbody>
			<tr>
			...
			<tr>
				<th colspan="2">확인을 누르면 관리자 정보로 이동합니다.</th>
			</tr>
					</tbody>
			<tfoot>
			<tr>
				<td colspan="2" align="center"><div class="allbtn">
				<input type="button" class="btn" value="리스트" onclick="location.href='tutorList'" />
				<input type="button" class="btn" value="확인" onclick="location.href='tutorInfo?tutorId=${tutorCommand.tutorId}'" />
				</div></td>
			</tr></tfoot>
		</table>
	</div>
