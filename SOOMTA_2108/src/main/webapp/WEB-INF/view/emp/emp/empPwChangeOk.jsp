...
<body>
	...
	<!-- 중앙 -->
	<div class="main">
	<input type="hidden" value="${employeeCommand.empId }"/>
		<table>
		<thead>
			<tr>
				<th colspan="2">'${employeeCommand.empId }'의 PW 변경 완료!
				</th>
			</tr></thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<input type="button" class="btn" value="리스트" onclick="location.href='empList'" />
				<input type="button" class="btn" value="확인" onclick="location.href='empInfo?empId=${employeeCommand.empId}'" />
				</div></td>
			</tr></tfoot>
		</table>
	</div>
