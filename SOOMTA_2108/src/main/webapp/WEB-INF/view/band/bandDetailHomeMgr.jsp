...
<%@ include file="../include/tags.jsp"%>
	...
	<!-- 중앙 상단부 -->
		<div class="bandTitle">
			...
			<div class="bandMenu"><a href="bandDetailHomeMgr?bandNo=${bandDTO.bandNo}">Home</a><a href="bandDetailallMgr?bandNo=${bandDTO.bandNo}">전체 게시글</a><a href="bandDetailmemMgr">멤버관리</a><a href="bandDetailmyMgr">내가 쓴 게시글</a>
		</div></div>
		<!-- 중앙 하단부 -->
