...
pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<!-- 중앙 상단부 -->
		<div class="bandTitle">
			<h1>BAND NAME</h1>
			<div class="bandMenu"><a href="bandDetail">Home</a><a href="bandDetailnotok">전체 게시글</a><a href="bandDetailnotok">멤버</a><a href="bandDetailnotok">내가 쓴 게시글</a>
		</div></div>
		<!-- 중앙 하단부 -->
  ...
  <tr>
  	<td colspan="4" style="text-align:right; font-weight:bold"><a href="bandDetailHome">공개</a>       <a href="bandDetailmember">  비공개</a></td>
  	</tr>
</tbody>
</table>
</table>
