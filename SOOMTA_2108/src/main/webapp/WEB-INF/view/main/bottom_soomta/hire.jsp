...
<body>
	...
	<div class="main">
		<div class="mainTitle">
			<h1>인재채용</h1>
			<p>
				 <a href="<c:url value='/about/soomta'/>">회사소개</a> 
				 <a href="<c:url value='/about/service'/>">서비스소개</a> 
				 <a href="<c:url value='/about/hire'/>">인재채용</a>
			</p>
		</div>
	<div class="table">
	<table><thead>
		...
		<c:set var="i" value="${i+1 }"/>
			<tr>
				...
				<td><a href="hireDetil?faqNo=${dto.faqNo }">${dto.faqTitle }</a></td>
